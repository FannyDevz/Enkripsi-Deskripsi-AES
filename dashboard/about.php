...
?>
  ...
  <body class="sidebar-mini fixed">
    <div class="wrapper">
      <header class="main-header hidden-print"><a class="logo" href="index.php" style="font-size:13pt">Aplikasi Enkripsi-Dekripsi</a>
            ...
            <div class="card">
              <div class="card-body">
                ...
                <p>Di era ini teknologi semakin maju dan pesat, dimana kerahasiaan data salah satunya yang sangat penting bagi sebuah perusahaan.<br>
                  ...
                  Aplikasi ini merupakan Aplikasi untuk menjaga kerahasiaan data-data penting.</p>
              </div>
            </div>
          </div>
        </div>
